...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-(--color-lebron-100) flex justify-center p-10">
      <Link href="/" className="text-(--color-lebron-400) text-xl flex fixed top-0 left-0 p-4 z-50 hover:opacity-15 transition">
  <FaArrowLeft />
</Link> 
...
{paymentMethod === "paypal" && (
          ...
          {paymentMethod === "pix" && (
            <p className="text-gray-500">
              Quando o pagamento for feito, você receberá uma email.
            </p>
          ...
          <button
            className="w-full bg-[var(--color-camel-500)] hover:bg-[var(--color-camel-600)] text-white py-3 rounded-lg font-semibold transition"
          >
            Pagar agora
          </button>
